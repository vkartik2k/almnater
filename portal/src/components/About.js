        ...
        return (
            <div className="aboutContainer">
                ...
                <div className="aboutContent">
                    Coding interview prep is a numbers game that many candidates lose. We've hand-picked 85 of the best coding interview questions to truly prepare you.
                </div>
            </div>
        )
    }
...
class AboutCard3 extends React.Component {
    render() {
        return (
            <div className="aboutContainer">
                <div className="aboutHeader">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 455.881 455.881" fill="rgb(98, 110, 227)" className="aboutLogo"><path d="M321.218 257.555c15.516-20.46 23.717-44.881 23.717-70.624 0-31.563-12.379-61.151-34.857-83.314-22.474-22.158-52.261-34.124-83.828-33.668-30.591.433-59.412 12.708-81.154 34.564-21.741 21.855-33.867 50.741-34.145 81.335-.238 26.228 8.011 51.088 23.855 71.894 25.721 33.776 39.887 75.149 39.887 116.498v45.244c0 20.069 16.327 36.396 36.396 36.396h33.854c20.069 0 36.396-16.328 36.396-36.396v-45.241c.001-41.806 13.691-82.157 39.879-116.688zm-174.478-8.9c-13.808-18.132-20.997-39.803-20.79-62.67.499-54.935 45.588-100.26 100.512-101.037 27.553-.37 53.493 10.035 73.084 29.352 19.597 19.321 30.389 45.116 30.389 72.632 0 22.442-7.147 43.729-20.669 61.56-27.593 36.385-42.45 78.833-43.058 122.93h-76.536c-.627-43.669-15.817-87.161-42.932-122.767zm42.953 165.746v-6.072l76.647 8.781v2.374c0 1.25-.13 2.468-.336 3.659l-76.311-8.742zm0-21.17v-6.809h76.647v15.59l-76.647-8.781zm21.396 47.65c-8.057 0-15.082-4.48-18.731-11.077l64.567 7.397a21.27 21.27 0 01-11.981 3.679h-33.855z"></path><path d="M153.776 198.213a76.76 76.76 0 01-.827-11.983 7.5 7.5 0 00-7.431-7.568c-4.114-.036-7.53 3.289-7.568 7.431a91.79 91.79 0 00.99 14.333 7.501 7.501 0 008.525 6.312 7.501 7.501 0 006.311-8.525zM197.913 312.135a7.5 7.5 0 007.126-9.844 237.946 237.946 0 00-36.82-69.994 75.768 75.768 0 01-7.016-11.079 7.5 7.5 0 10-13.325 6.889 90.891 90.891 0 008.408 13.278 222.98 222.98 0 0134.504 65.591 7.502 7.502 0 007.123 5.159zM306.746 212.613a7.5 7.5 0 00-9.855 3.921 75.018 75.018 0 01-9.139 15.643 7.5 7.5 0 0011.952 9.063 90.13 90.13 0 0010.963-18.772 7.499 7.499 0 00-3.921-9.855zM227.941 111.938c41.352 0 74.994 33.643 74.994 74.995 0 2.351-.108 4.72-.321 7.041a7.5 7.5 0 0014.937 1.371c.254-2.775.384-5.605.384-8.412 0-49.623-40.371-89.995-89.994-89.995a7.5 7.5 0 000 15zM227.941 57a7.5 7.5 0 007.5-7.5v-42a7.5 7.5 0 00-15 0v42a7.5 7.5 0 007.5 7.5zM152.065 71.82a7.497 7.497 0 0010.245 2.746 7.5 7.5 0 002.746-10.245l-20.99-36.36a7.5 7.5 0 00-12.991 7.499l20.99 36.36zM388.22 272.115l-36.36-20.99a7.498 7.498 0 00-10.245 2.746 7.5 7.5 0 002.746 10.245l36.36 20.99a7.498 7.498 0 0010.245-2.746 7.5 7.5 0 00-2.746-10.245zM67.661 104.366l36.36 20.99a7.498 7.498 0 0010.245-2.746 7.5 7.5 0 00-2.746-10.245l-36.36-20.99a7.499 7.499 0 00-10.245 2.746 7.5 7.5 0 002.746 10.245zM408.68 180.74h-42a7.5 7.5 0 000 15h42a7.5 7.5 0 000-15zM96.7 188.24a7.5 7.5 0 00-7.5-7.5h-42a7.5 7.5 0 000 15h42a7.5 7.5 0 007.5-7.5zM348.117 126.362a7.465 7.465 0 003.743-1.006l36.36-20.99a7.5 7.5 0 00-7.499-12.991l-36.36 20.99a7.5 7.5 0 003.756 13.997zM104.021 251.125l-36.36 20.99a7.5 7.5 0 007.499 12.991l36.36-20.99a7.5 7.5 0 00-7.499-12.991zM293.571 74.566a7.498 7.498 0 0010.245-2.746l20.99-36.36a7.5 7.5 0 00-12.991-7.499l-20.99 36.36a7.5 7.5 0 002.746 10.245z"></path></svg>
                    <br />
                    <br />
                    85 Hand-Picked Questions
                </div>
        ...
        return (
            <div>
                ...
                <div style={{textAlign: 'center'}}>
                    ...
                    <span style={{padding: 5}}>Watch the Video</span>
                    </Button>
                </div>
